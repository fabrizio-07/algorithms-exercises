...
int main(int argc, char **argv){
    ...
    cout<<"This program looks for a certain x value in the BST."<<endl;
    ...
    cout<<"What element would you like to look for?\t";
    cin>>element;

    (searchValue(tree.getRoot(),element) ? cout<<"The BST contains "<<element<<endl : cout<<"The BST doesn't contain "<<element<<endl);
